...
import { extractTripArtifacts } from "@/lib/extract-artifacts";
...
export function AgentChat() {
  ...
  return (
    <main className="flex h-[calc(100dvh-3.5rem)] flex-col overflow-hidden bg-background text-foreground lg:flex-row">
        ...
        {isEmpty ? (
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <p className="max-w-md text-muted-foreground text-sm">
              Suggest itineraries, then compare MakeMyTrip, Goibibo, and EaseMyTrip. Booking happens
              on the cheapest platform — we never charge your card here.
            </p>
          </div>
        ) : null}
      ...
      <aside className="min-h-0 w-full overflow-y-auto border-t p-4 lg:w-[28rem] lg:border-t-0 lg:border-l">
        <div className="space-y-4">
          <BookingConfirmCard handoff={artifacts.handoff} />
          <ItineraryCanvas itinerary={artifacts.itinerary} />
          <FareTable comparison={artifacts.comparison} />
        </div>
      </aside>
    </main>
  );
